...
O que aconteceu, onde, com quem e por quê.

## AVALIAÇÃO PRELIMINAR DE RELEVÂNCIA

- Tipo de impacto: (econômico, político, social, tecnológico, internacional)
- Alcance: (local, nacional, internacional)
- Magnitude: (baixa, média, alta)
- Urgência: (baixa, média, alta)
- Potencial de desdobramentos: (baixo, médio, alto)
...
## NÍVEL DE CONFIANÇA DA APURAÇÃO

- Alto: múltiplas fontes consistentes
- Médio: algumas divergências
- Baixo: muitas lacunas ou inconsistências
```
...
- Se não houver informação exclusiva para uma fonte, omita o campo ou escreva "N/A"
